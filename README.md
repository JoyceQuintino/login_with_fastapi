...
No endpoint de register são passados user e password possibilitando o cadastro de usuário no banco de dados. Tem o endpoint de login possibilitando o usuário logar se user e password forem válidos, será retornado um jw token. Além desses, tem o endpoint para testar o token e se válido retorna o dado,  caso não retorna erro.  
